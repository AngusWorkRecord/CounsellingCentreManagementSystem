      ...
      >
        <Scrollbar sx={{ height: 1 }}>
          <Stack direction="row" alignItems="center" justifyContent="space-around" sx={{ p: 2.5 }}>
            ...
            <Typography variant="h6"> {tr("Sarawak")} </Typography>
          </Stack>
          <Divider />
          <Stack sx={{ p: 2.5 }}>
            <Typography variant="h6"> {currentDetails?.title} </Typography>
            {/* <Typography variant='caption'>SDR</Typography> */}
            <Typography variant='subtitle2'>{tr("Overall Score")}</Typography>
          </Stack>
          <Divider />
          <Stack sx={{ p: 2.5 }}>
            <Typography variant='subtitle2'>{tr("Score:")} {currentDetails?.overallScore}</Typography>
            <Typography variant='subtitle2'>{tr("Rank:")} {currentDetails?.rank}</Typography>
          </Stack>
          <Divider />
          <Stack sx={{ p: 2.5 }}>
            <Typography variant='subtitle2'>{tr("Description")}</Typography>
            <Typography variant='caption'> {currentDetails?.desc} </Typography>
          </Stack>
          <Stack sx={{ p: 2.5 }}>
            <Typography variant="subtitle2"> {tr("Performance on SDG")} </Typography>
