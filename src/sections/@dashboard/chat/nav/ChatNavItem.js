...
const getDetails = (conversation, currentUserId) => {
  ...
  const UserFirstNames = otherParticipants.map((participant) => participant.name).join(', ');
  ...
  return { otherParticipants, UserFirstNames, displayText };
};
