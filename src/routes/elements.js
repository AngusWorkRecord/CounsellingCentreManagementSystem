...
export const CounsellingCaseEditPage = Loadable(
  lazy(() => import('../pages/dashboard/CounsellingCaseEditPage'))
);
...
export const EventListPage = Loadable(
  lazy(() => import('../pages/dashboard/EventListPage'))
);


export const GeneralFilePage = Loadable(lazy(() => import('../pages/dashboard/GeneralFilePage')));
export const GeneralPlaceDetailPage = Loadable(lazy(() => import('../pages/dashboard/GeneralPlaceDetailPage')));
export const GeneralGoalsListPage = Loadable(lazy(() => import('../pages/dashboard/GeneralGoalsListPage')));
...
export const EmailTemplatelisting = Loadable(lazy(() => import('../pages/dashboard/settings/emailTemplate/emailTemplateListing')));
