...
export const PATH_CONFERENCE_MANAGEMENT = {
  ...
  conference: {
    ...
    form: path(ROOTS_CONFERENCE, '/conference-event-management/form'),
  },
  journal: {
...
export const PATH_DASHBOARD = {
  ...
  general: {
    ...
    place: (selectedPlaceID) => path(ROOTS_DASHBOARD, `/place/${selectedPlaceID}`),
    list: (selectedID) => path(ROOTS_DASHBOARD, `/goals/list/${selectedID}`),
  },
