...
import {
  ...
  CounsellingCaseEditPage,
  CounsellingCaseDetailPage,
  GeneralSDGPage,
  EventListPage,
  GeneralEcommercePage,
  GeneralAnalyticsPage,
  GeneralPlaceDetailPage,
  GeneralGoalsListPage,
  // Dashboard: User
  UserListPage,
  UserEditPage,
  UserCardsPage,
  ...
  return useRoutes([
    ...
    // Dashboard
    {
      ...
      children: [
        ...
        { path: 'sdg/:selectedID', element: <GeneralSDGPage /> },
        ...
        { path: 'counselling/cases/:id/edit', element: <CounsellingCaseEditPage /> },
        ...
        { path: 'goals/list/:selectedID', element: <GeneralGoalsListPage /> },
        { path: 'events', element: <EventListPage /> },
        // {
        //   path: 'mailTemplate',
        //   children: [
        //     { element: <Navigate to="/dashboard/mailTemplate/list" replace />, index: true },
        //     { path: 'list', element: <EmailTemplatelisting /> },
      ...
      children: [
        { element: <ConferenceEventManagementIndexPage />, index: true },
        {
          ...
          children: [
            ...
            { path: 'form', element: <ConferenceEventManagementForm /> },
          ],
        },
        {
        ...
        },
        {
          ...
          children: [
            ...
            // { path: 'form', element: <EventManagementForm /> },
          ],
        },
      ],
    },
